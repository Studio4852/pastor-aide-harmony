...
const EventsPage = () => (
  <div className="max-w-7xl mx-auto space-y-6">
    ...
    <div className="grid grid-cols-3 gap-4">
      {events.map((event) => (
        <div key={event.title} className="bg-card border border-border rounded-xl overflow-hidden animate-fade-in">
          <div className="p-5 space-y-3">
            ...
            <div className="h-1 bg-secondary rounded-full overflow-hidden">
              <div className="h-full rounded-full bg-warning" style={{ width: `${event.progress}%` }} />
            </div>
          </div>
          <div className="border-t border-border px-5 py-3 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button className="w-8 h-8 rounded-lg border border-border flex items-center justify-center text-muted-foreground hover:bg-secondary">
